...
fun Started.updateComponent(
    id: ComponentId,
    how: (mapping: ComponentState) -> ComponentState?
) =
...
fun ComponentState.appendSnapshot(
...
fun ComponentState.removeSnapshots(
    ids: Set<SnapshotId>
): ComponentState =
    copy(
...
fun ComponentState.removeSnapshots(): ComponentState =
    copy(
...
inline fun DebugState.updateComponent(
    id: ComponentId,
    crossinline how: (mapping: ComponentState) -> ComponentState?
) =

...
This library isn't production-ready yet and was originally intended as a pet project to give TEA a
...
- **Scalability**: it is built on top of a simple idea of having pure functions that operate on
  plain data separated from impure ones. Those functions are building blocks and form testable
...
- **tea-time-travel-adapter-gson**: implements debug protocol and serialization by means
  of the [Gson](https://github.com/google/gson) library. Should be added as a dependency together with the **tea-time-travel** module.
